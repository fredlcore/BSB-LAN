...
S'il te manque une fiche appropriée pour la connexion au contrôleur, tu peux improviser avec des [contrefiche plate, largeur : 6,35 mm](https://www.reichelt.com/de/fr/shop/produit/contrefiche_plate_entierement_isolee_largeur_6_35_mm_bleu-231369).  
...
1. Si la connexion entre le contrôleur et l’adaptateur BSB-LAN est correcte, alors la LED rouge de l’adaptateur devrait s’allumer et clignoter de temps en temps. Si elle ne clignote pas, vérifie si l’adaptateur a été accidentellement connecté à la broche `G+` du contrôleur. Cette broche fournit uniquement de l’alimentation, mais pas de données. Si la LED reste éteinte lorsqu’elle est connectée aux connecteurs LPB, alors il se peut que l’alimentation LPB doive être activée dans les réglages LPB du contrôleur.
