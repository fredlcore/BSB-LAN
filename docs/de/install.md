...
Wenn für den Anschluss am Regler ein passender Stecker fehlt, kann man auch mit [6,35mm Flachsteckerhülsen](https://www.reichelt.de/de/de/shop/produkt/flachsteckerhuelse-vollisoliert_breite_6_35mm_blau-231369) improvisieren.  
...
1. Wenn die Verbindung zwischen dem Regler und dem BSB-LAN-Adapter korrekt ist, sollte die rote LED auf dem Adapter leuchten und gelegentlich flackern. Leuchtet sie durchgehend, ist zu prüfen, ob der Adapter ggf. versehentlich an den `G+`-Pin angeschlossen wurde. Dieser liefert zwar Spannung, aber keine Daten. Wenn die LED beim Anschluss an LPB nicht leuchtet, muss ggf. noch die Busspeisung in den Einstellungen des Reglers aktiviert werden.
