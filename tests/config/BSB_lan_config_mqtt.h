...
#ifndef WIFI                            // mDNS currently does not work with the WiFiSpi library
 ...
 * The example in the comment below sets username to "atari" and password to "800xl". Visit a website like
...
#define AVERAGES
bool logAverageValues = true;  // calculate and save data into averages.txt on SD-card.
