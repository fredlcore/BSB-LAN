...
Gasregler:  
- [LMU74/LMU75](https://github.com/1coderookie/BSB-LPB-LAN/blob/master/docs/kap03.md#3211-lmu-regler) und (aktuelle Generation) [LMS14/LMS15](https://github.com/1coderookie/BSB-LPB-LAN/blob/master/docs/kap03.md#3212-lms-regler), Anschluss via BSB, vollumfänglich steuer- und bedienbar  
- [LMU54/LMU64](https://github.com/1coderookie/BSB-LPB-LAN/blob/master/docs/kap03.md#3211-lmu-regler), Anschluss via PPS, eingeschränkt steuer- und bedienbar   
   
Öl-/Solar-/Zonenregler:  
- [RVS43/RVS63/RVS46](https://github.com/1coderookie/BSB-LPB-LAN/blob/master/docs/kap03.md#3222-rvs-regler), Anschluss via BSB, vollumfänglich steuer- und bedienbar  
- [RVA/RVP](https://github.com/1coderookie/BSB-LPB-LAN/blob/master/docs/kap03.md#3221-rva--und-rvp-regler), Anschluss via PPS (modellspezifisch vereinzelt auch LPB), eingeschränkt steuer- und bedienbar  
   
Wärmepumpenregler:  
- [RVS21/RVS61](https://github.com/1coderookie/BSB-LPB-LAN/blob/master/docs/kap03.md#3222-rvs-regler), Anschluss via BSB, vollumfänglich steuer- und bedienbar  
