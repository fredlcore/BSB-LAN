...
#define MENU_TEXT_BUT "Log unknown bus telegrams only"
#define MENU_TEXT_UBT "Log unknown broadcast bus telegrams only"
...
#define CF_NETWORK_TYPE_TEXT "Network type"
