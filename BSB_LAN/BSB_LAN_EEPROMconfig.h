...
// Version 15 (control MQTT unit set)
  CF_MQTT_UNITS, //Size: 1 byte. Unit of measure for MQTT: 0 - localised, 1 - homeassistant, 255 - none
...
//  {CF_OWN_BSBADDR,      1, CCAT_BUS,      CPI_NOTHING,   CDT_BYTE,           OPT_FL_ADVANCED, NULL, sizeof(byte)},//Not used. Leaved for compatibility
  ...
  {CF_MQTT_UNITS,      15, CCAT_MQTT,     CPI_DROPDOWN,  CDT_BYTE,           OPT_FL_ADVANCED, CF_MQTT_UNITS_TXT, sizeof(mqtt_unit_set)},//need reboot.
