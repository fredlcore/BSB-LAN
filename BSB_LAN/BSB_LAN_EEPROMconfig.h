...
// Version 0 (header + PPS values + space for MAX! devices)
  ...
  CF_PPS_VALUES, //
// Version 1.1 (parameters which can be changed by URL commands)
...
//Version 1.3 (Web-config, some forgotten options)
...
// Version 1.8 (bus pins and device family and variant)
...
PROGMEM_LATE const configuration_struct config[]={
#ifdef WEBCONFIG
  {CF_CONFIG_LEVEL,     1, CCAT_GENERAL,  CPI_SWITCH,    CDT_BYTE,           OPT_FL_BASIC|OPT_FL_ADVANCED, CF_CONFIG_LEVEL_TXT, sizeof(config_level)}, //immediately apply
#endif
...
#ifdef WEBCONFIG
  {CF_WRITEMODE,        1, CCAT_GENERAL,  CPI_DROPDOWN,  CDT_BYTE,           OPT_FL_ADVANCED, CF_WRITEMODE_TXT, sizeof(programWriteMode)},
  {CF_CHECKUPDATE,      1, CCAT_GENERAL,  CPI_SWITCH,    CDT_BYTE,           OPT_FL_ADVANCED, CF_CHECKUPDATE_TXT, sizeof(enable_version_check)}, //immediately apply
  {CF_OTA_UPDATE,       1, CCAT_GENERAL,  CPI_SWITCH,    CDT_BYTE,           OPT_FL_ADVANCED, CF_OTA_UPDATE_TXT, sizeof(enable_ota_update)}, //immediately apply
#endif
  {CF_RX_PIN,           1, CCAT_BUS,      CPI_TEXT,      CDT_BYTE,           OPT_FL_ADVANCED, CF_RX_PIN_TXT, sizeof(bus_pins[0])},//need reboot
  {CF_TX_PIN,           1, CCAT_BUS,      CPI_TEXT,      CDT_BYTE,           OPT_FL_ADVANCED, CF_TX_PIN_TXT, sizeof(bus_pins[0])},//need reboot
  ...
  {CF_ROOM_DEVICE,      1, CCAT_BUS,      CPI_DROPDOWN,  CDT_UINT16,         OPT_FL_BASIC|OPT_FL_ADVANCED, CF_QAA_TYPE_TXT, sizeof(pps_values[PPS_QTP])},//immediately apply
  {CF_DEVICE_FAMILY,    1, CCAT_BUS,      CPI_TEXT,      CDT_UINT16,         OPT_FL_ADVANCED, STR6225, sizeof(fixed_device_family)},//need reboot
  {CF_DEVICE_VARIANT,   1, CCAT_BUS,      CPI_TEXT,      CDT_UINT16,         OPT_FL_ADVANCED, STR6226, sizeof(fixed_device_variant)},//need reboot
#ifdef WEBCONFIG
  {CF_PASSKEY,          1, CCAT_IPV4,     CPI_TEXT,      CDT_STRING,         OPT_FL_ADVANCED, CF_PASSKEY_TXT, sizeof(PASSKEY)},//immediately apply
  {CF_BASICAUTH,        1, CCAT_IPV4,     CPI_TEXT,      CDT_STRING,         OPT_FL_ADVANCED, CF_BASICAUTH_TXT, sizeof(USER_PASS)},//immediately apply
  {CF_DHCP,             1, CCAT_IPV4,     CPI_SWITCH,    CDT_BYTE,           OPT_FL_BASIC|OPT_FL_ADVANCED, CF_DHCP_TXT, sizeof(useDHCP)}, //need reboot
  {CF_IPADDRESS,        1, CCAT_IPV4,     CPI_TEXT,      CDT_IPV4,           OPT_FL_BASIC|OPT_FL_ADVANCED, CF_IPADDRESS_TXT, sizeof(ip_addr)}, //need reboot
  {CF_MASK,             1, CCAT_IPV4,     CPI_TEXT,      CDT_IPV4,           OPT_FL_BASIC|OPT_FL_ADVANCED, CF_MASK_TXT, sizeof(subnet_addr)}, //need reboot
  {CF_GATEWAY,          1, CCAT_IPV4,     CPI_TEXT,      CDT_IPV4,           OPT_FL_BASIC|OPT_FL_ADVANCED, CF_GATEWAY_TXT, sizeof(gateway_addr)}, //need reboot
  {CF_DNS,              1, CCAT_IPV4,     CPI_TEXT,      CDT_IPV4,           OPT_FL_BASIC|OPT_FL_ADVANCED, CF_DNS_TXT, sizeof(dns_addr)}, //need reboot
  {CF_WWWPORT,          1, CCAT_IPV4,     CPI_TEXT,      CDT_UINT16,         OPT_FL_ADVANCED, CF_WWWPORT_TXT, sizeof(HTTPPort)}, //need reboot - can't destroy EthernetServer object
  {CF_MAC,              1, CCAT_IPV4,     CPI_TEXT,      CDT_MAC,            OPT_FL_ADVANCED, CF_MAC_TXT, sizeof(mac)}, //need reboot
  {CF_TRUSTEDIPADDRESS, 1, CCAT_IPV4,     CPI_TEXT,      CDT_IPV4,           OPT_FL_ADVANCED, CF_TRUSTEDIPADDRESS_TXT, sizeof(trusted_ip_addr)}, //immediately apply
  {CF_TRUSTEDIPADDRESS2,1, CCAT_IPV4,     CPI_TEXT,      CDT_IPV4,           OPT_FL_ADVANCED, CF_TRUSTEDIPADDRESS_TXT, sizeof(trusted_ip_addr2)},//immediately apply
  {CF_WIFI_SSID,        1, CCAT_IPV4,     CPI_TEXT,      CDT_STRING,         OPT_FL_BASIC|OPT_FL_ADVANCED, CF_WIFI_SSID_TXT, sizeof(wifi_ssid)}, //need reboot
  {CF_WIFI_PASSWORD,    1, CCAT_IPV4,     CPI_TEXT,      CDT_STRING,         OPT_FL_BASIC|OPT_FL_ADVANCED, CF_WIFI_PASSWORD_TXT, sizeof(wifi_pass)},//need reboot
  {CF_MDNS_HOSTNAME,    1, CCAT_IPV4,     CPI_TEXT,      CDT_STRING,         OPT_FL_ADVANCED, CF_MDNS_HOSTNAME_TXT, sizeof(mDNS_hostname)},//need reboot
  {CF_MQTT,             1, CCAT_MQTT,     CPI_DROPDOWN,  CDT_BYTE,           OPT_FL_ADVANCED, CF_USE_TXT, sizeof(mqtt_mode)},//need handler
  {CF_MQTT_IPADDRESS,   1, CCAT_MQTT,     CPI_TEXT,      CDT_IPV4,           OPT_FL_ADVANCED, CF_MQTT_IPADDRESS_TXT, sizeof(mqtt_broker_ip_addr)},//need handler
  {CF_MQTT_USERNAME,    1, CCAT_MQTT,     CPI_TEXT,      CDT_STRING,         OPT_FL_ADVANCED, CF_MQTT_USERNAME_TXT, sizeof(MQTTUsername)},//immediately apply
  {CF_MQTT_PASSWORD,    1, CCAT_MQTT,     CPI_TEXT,      CDT_STRING,         OPT_FL_ADVANCED, CF_MQTT_PASSWORD_TXT, sizeof(MQTTPassword)},//immediately apply
  {CF_MQTT_DEVICE,      1, CCAT_MQTT,     CPI_TEXT,      CDT_STRING,         OPT_FL_ADVANCED, CF_MQTT_DEVICE_TXT, sizeof(MQTTDeviceID)}, //immediately apply
  {CF_MQTT_TOPIC,       1, CCAT_MQTT,     CPI_TEXT,      CDT_STRING,         OPT_FL_ADVANCED, CF_MQTT_TOPIC_TXT, sizeof(MQTTTopicPrefix)},//immediately apply

#endif
  {CF_LOGMODE,          1,CCAT_LOGGING,  CPI_CHECKBOXES,CDT_BYTE,           OPT_FL_BASIC|OPT_FL_ADVANCED, CF_LOGMODE_TXT, sizeof(LoggingMode)}, //immediately apply
...
#ifdef WEBCONFIG
  {CF_WEBSERVER,        1, CCAT_GENERAL,  CPI_SWITCH,    CDT_BYTE,           OPT_FL_ADVANCED, CF_WEBSERVER_TXT, 1},
  {CF_ONEWIREBUS,       1, CCAT_ONEWIREBUS,CPI_TEXT,     CDT_BYTE,           OPT_FL_ADVANCED, CF_PINS_TXT, sizeof(One_Wire_Pin)}, //need reboot.
//bus and pins: DHT_Pins
  {CF_DHTBUS,           1, CCAT_DHTBUS,   CPI_TEXT,      CDT_DHTBUS,         OPT_FL_ADVANCED, CF_PINS_TXT, sizeof(DHT_Pins)}, //immediately apply
  {CF_BMEBUS,           1, CCAT_BMEBUS,   CPI_TEXT,      CDT_BYTE,           OPT_FL_ADVANCED, CF_NUM_TXT, sizeof(BME_Sensors)}, //need reboot
  {CF_TWW_PUSH_PIN_ID,  1, CCAT_RGT_EMUL, CPI_TEXT,      CDT_BYTE,           OPT_FL_ADVANCED, CF_TWW_PUSH_PIN_TXT, sizeof(button_on_pin[0])},//need reboot
  {CF_RGT1_SENSOR_ID,   1, CCAT_RGT_EMUL, CPI_TEXT,      CDT_PROGNRLIST,     OPT_FL_ADVANCED, CF_RGT1_SENSOR_TXT, sizeof(rgte_sensorid)/3},//immediately apply
  {CF_RGT1_PRES_PIN_ID, 1, CCAT_RGT_EMUL, CPI_TEXT,      CDT_BYTE,           OPT_FL_ADVANCED, CF_RGT1_PRES_PIN_TXT, sizeof(button_on_pin[0])},//need reboot
  {CF_RGT2_SENSOR_ID,   1, CCAT_RGT_EMUL, CPI_TEXT,      CDT_PROGNRLIST,     OPT_FL_ADVANCED, CF_RGT2_SENSOR_TXT, sizeof(rgte_sensorid)/3},//immediately apply
  {CF_RGT2_PRES_PIN_ID, 1, CCAT_RGT_EMUL, CPI_TEXT,      CDT_BYTE,           OPT_FL_ADVANCED, CF_RGT2_PRES_PIN_TXT, sizeof(button_on_pin[0])},//need reboot
  {CF_RGT3_SENSOR_ID,   1, CCAT_RGT_EMUL, CPI_TEXT,      CDT_PROGNRLIST,     OPT_FL_ADVANCED, CF_RGT3_SENSOR_TXT, sizeof(rgte_sensorid)/3},//immediately apply
  {CF_RGT3_PRES_PIN_ID, 1, CCAT_RGT_EMUL, CPI_TEXT,      CDT_BYTE,           OPT_FL_ADVANCED, CF_RGT3_PRES_PIN_TXT, sizeof(button_on_pin[0])},//need reboot
  {CF_MAX,              1, CCAT_MAX,      CPI_SWITCH,    CDT_BYTE,           OPT_FL_ADVANCED, CF_USE_TXT, sizeof(enable_max_cul)},//immediately apply
  {CF_MAX_IPADDRESS,    1, CCAT_MAX,      CPI_TEXT,      CDT_IPV4,           OPT_FL_ADVANCED, CF_MAX_IPADDRESS_TXT, sizeof(max_cul_ip_addr)}, //need reboot. Can use handler to reconfigure in future
#endif
#endif
...
#ifdef CONFIG_IN_EEPROM
#ifdef WEBCONFIG
  {CF_IPWEVALUESLIST,   1, CCAT_IPWE,     CPI_TEXT,      CDT_PROGNRLIST,     OPT_FL_ADVANCED, CF_PROGLIST_TXT, sizeof(ipwe_parameters)},//immediately apply
  {CF_DEBUG,            1, CCAT_DEBUG,    CPI_DROPDOWN,  CDT_BYTE,           OPT_FL_ADVANCED, CF_USE_TXT, sizeof(debug_mode)},
  {CF_VERBOSE,          1, CCAT_DEBUG,    CPI_SWITCH,    CDT_BYTE,           OPT_FL_ADVANCED, CF_VERBOSE_TXT, sizeof(verbose)},
  {CF_MONITOR,          1, CCAT_DEBUG,    CPI_SWITCH,    CDT_BYTE,           OPT_FL_ADVANCED, CF_MONITOR_TXT, sizeof(monitor)},
  {CF_SHOW_UNKNOWN,     1, CCAT_DEBUG,    CPI_SWITCH,    CDT_BYTE,           OPT_FL_ADVANCED, CF_SHOW_UNKNOWN_TXT, sizeof(show_unknown)}//immediately apply
#endif
#endif
};
