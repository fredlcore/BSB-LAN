...
In addition, there are now also Siemens controllers that no longer expose BSB/LPB connectors, but use different bus systems, for example the LMU34 and the Climatix/POS-series.
<BR><BR>
