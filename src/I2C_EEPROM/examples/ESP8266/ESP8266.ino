...
void setup() 
{
   ...
   // ESP8266 User geben hier die Pins an
   // Wire.begin(); // default, sind Pin 4,5
   Wire.begin(0,1); // brauchbar für ESP8266-01
   // Wire.begin(12,14); // brauchbar für ESP8266-201

   // die Speichergröße des EEProm wird in der Klasse gespeichert
   // kann also ausgelesen werden, ohne das das EEProm wirlich
   // bereit ist 
